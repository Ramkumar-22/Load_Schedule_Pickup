...
* The original package name 'com.pickupscheduler.local-pickup-scheduler' is invalid and this project uses 'com.pickupscheduler.local_pickup_scheduler' instead.
